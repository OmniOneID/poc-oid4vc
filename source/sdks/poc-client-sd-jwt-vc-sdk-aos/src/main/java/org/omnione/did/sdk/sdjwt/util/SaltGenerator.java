...
public class SaltGenerator {
  ...
  private SaltGenerator() {
    throw new SDJWTException("SaltGenerator is a utility class and cannot be instantiated");
  }
  ...
  public static void validateSalt(String salt) {
    if (salt == null) {
      throw new SDJWTException("Salt cannot be null");
    }
    if (salt.isEmpty()) {
      throw new SDJWTException("Salt cannot be empty");
    }
