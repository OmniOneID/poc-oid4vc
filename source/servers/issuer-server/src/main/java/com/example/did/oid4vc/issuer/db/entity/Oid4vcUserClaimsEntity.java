...
@Setter
@Entity
@Table(name = "t_oid4vc_user_claims", uniqueConstraints = {
    @UniqueConstraint(columnNames = {"user_id", "credential_type"})
})
public class Oid4vcUserClaimsEntity extends BaseEntity {
    ...
    @Column(name = "credential_type", length = 128, nullable = false)
