...
package org.omnione.did.oid4vc.authorization.authorization.oid4vci.credentialidentifier.api;
...
@FeignClient(name = "credential-issuer", contextId = "sdkIssuerFeignClient", url = "${oid4vc.auth.clients.issuer-server.url}")
